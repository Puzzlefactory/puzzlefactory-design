...
- `packages/themes` is now the real `@puzzlefactory/themes` workspace package. Its first slice defines the versioned canonical theme source, theme identity and region mapping validation, normalized color-engine input, and explicit theme/color-engine contract versions above `@puzzlefactory/color-engine`.
...
packages/
  ...
  themes/        // @puzzlefactory/themes; canonical theme source and validation, with composition/artifact slices in progress
