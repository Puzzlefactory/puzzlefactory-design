...
- `packages/color-engine` is now the v2 `@puzzlefactory/color-engine` workspace package; current v2 output includes neutral/surface generation, explicit-seed primary usage ramps, explicit-seed status usage ramps, stable semantic aliases, and structured CSS output
...
```
packages/
  color-engine/    // @puzzlefactory/color-engine; v2 neutral/surface plus primary/status usage implementation, semantic aliases, and CSS output
