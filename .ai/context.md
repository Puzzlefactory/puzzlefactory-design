...
- `packages/themes` remains a placeholder, but its intended future boundary is now documented: full theme composition, presets, region mapping schemas, manifest helpers, and local artifact orchestration above `@puzzlefactory/color-engine` and future broader tokens
...
packages/
  ...
  themes/        // @puzzlefactory/themes; future theme composition, manifest, region mapping, and artifact orchestration package (placeholder only)
