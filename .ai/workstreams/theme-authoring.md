...
- `TA-15`: Hardened storage shape validation, compact canonical publication records, tamper detection, revision/role-number integer boundaries, committed-identity async request guards, repository CI/browser coverage, and accessible button naming; independent re-review approved the result.
