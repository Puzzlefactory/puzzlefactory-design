...
Status: React + Vite + React Router 7 verification shell wired to v2 neutral/surface/chrome/primary/status color-engine output, curated theme presets, theme-specific dark seeds, seed policy, text treatment strategies, generated semantic aliases, and APCA assertion diagnostics.
